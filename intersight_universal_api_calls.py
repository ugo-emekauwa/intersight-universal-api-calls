"""
Cisco Intersight Universal API Calls Module, v1.0
Author: Ugo Emekauwa
...
def iu_get(api_path):
  ...
  try:
    if api_instance.last_response.status is 200:     
      response = api_instance.last_response.data
      results = json.loads(response)
      return results
    else:
      print("HTTP Response Status Code: " + api_instance.last_response.status)
  except Exception as exception_message:
    print("Unable to obtain the last response.")
...
def iu_delete_moid(api_path,moid):
  ...
  try:
    ...
    print("The deletion of the object located at the resource path '" + full_resource_path + "' has been successful.")
  except Exception as exception_message:
    print("Unable to access the object located at the resource path '" + full_resource_path + "'.")
    print(exception_message)
...
def iu_post(api_path,body):
  ...
  try:
    ...
    print("The post of the object located at the resource path '" + full_resource_path + "' has been successful.")
  except Exception as exception_message:
    print("Unable to post the object at the resource path '" + full_resource_path + "'.")
    print(exception_message)
...
def iu_patch_moid(api_path,moid,body):
  ...
  try:
    ...
    print("The patch of the object located at the resource path '" + full_resource_path + "' has been successful.")
  except Exception as exception_message:
    print("Unable to access the object located at the resource path '" + full_resource_path + "'.")
    print(exception_message)
